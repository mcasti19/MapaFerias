                ...
                <div className="flex-1 overflow-y-auto bg-slate-100 dark:bg-slate-800 p-8 transition-colors duration-300">
                    <div className="max-w-7xl mx-auto space-y-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            {/* Bar Chart */}
                            <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/60 rounded-3xl p-6 shadow-sm">
                            ...
                            {/* Pie Chart */}
                            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/60 rounded-3xl p-6 shadow-sm">
